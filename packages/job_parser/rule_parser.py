...
from packages.job_parser.models import JobInput, ParsedJob, SeniorityLevel
...
class RuleJobParser:
    ...
    def parse(self, job: JobInput) -> ParsedJob:
        ...
        return ParsedJob(
            ...
            salary=salary,
            outsourcing_detected=any(word in text for word in ("人力外包", "驻场外包", "外包项目")),
            headhunter_detected=any(word in text for word in ("猎头", "代招")),
            internship_detected="实习" in text,
